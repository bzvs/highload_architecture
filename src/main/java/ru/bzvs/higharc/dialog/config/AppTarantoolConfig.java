package ru.bzvs.higharc.dialog.config;
...
@Configuration
@EnableTarantoolRepositories(basePackageClasses = MessageRepository.class)
public class AppTarantoolConfig extends AbstractTarantoolDataConfiguration {
